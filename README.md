...
| Technology | Purpose |
|---|---|
| **Node.js 24 + Express 5** | Server & API routes |
...
| Technology | Purpose |
|---|---|
| **OpenAI Whisper** (`gpt-4o-mini-transcribe`) | Speech-to-text transcription |
| **GPT-5.2** | Pronunciation scoring & feedback generation |
| **Web MediaRecorder API** | In-browser audio capture |

### Tooling
| Technology | Purpose |
|---|---|
| **pnpm workspaces** | Monorepo package management |
| **Orval** | Auto-generates typed API client hooks from OpenAPI spec |
| **OpenAPI / YAML** | API-first design — all endpoints documented before implementation |

## 🗄️ Database Schema

```
┌─────────────────┐    ┌──────────────────┐    ┌─────────────────────┐
│   exercises      │    │   patients        │    │   therapy_sessions  │
│─────────────────│    │──────────────────│    │─────────────────────│
│ id              │    │ id               │    │ id                  │
│ kannadaText     │    │ name             │◄───┤ patientId           │
│ transliteration │    │ age              │    │ startTime           │
│ englishMeaning  │    │ condition        │    │ endTime             │
│ category        │    │ therapistNotes   │    │ status              │
